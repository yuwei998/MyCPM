    ...
    def _build_model(self):
        ...
        with tf.variable_scope('sub_stages'):
            sub_conv1 = tf.layers.conv2d(inputs=self.input_images,
                                         ...
                                         name='sub_conv1')
            sub_conv1=tf.contrib.layers.batch_norm(sub_conv1, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv2 = tf.layers.conv2d(inputs=sub_conv1,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv2')
            sub_conv2=tf.contrib.layers.batch_norm(sub_conv2, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            ...
            sub_conv3 = tf.layers.conv2d(inputs=sub_pool1,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv3')
            sub_conv3=tf.contrib.layers.batch_norm(sub_conv3, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv4 = tf.layers.conv2d(inputs=sub_conv3,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv4')
            sub_conv4=tf.contrib.layers.batch_norm(sub_conv4, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            ...
            sub_conv5 = tf.layers.conv2d(inputs=sub_pool2,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv5')
            sub_conv5=tf.contrib.layers.batch_norm(sub_conv5, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv6 = tf.layers.conv2d(inputs=sub_conv5,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv6')
            sub_conv6=tf.contrib.layers.batch_norm(sub_conv6, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv7 = tf.layers.conv2d(inputs=sub_conv6,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv7')
            sub_conv7=tf.contrib.layers.batch_norm(sub_conv7, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv8 = tf.layers.conv2d(inputs=sub_conv7,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv8')
            sub_conv8=tf.contrib.layers.batch_norm(sub_conv8, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            ...
            sub_conv9 = tf.layers.conv2d(inputs=sub_pool3,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='sub_conv9')
            sub_conv9=tf.contrib.layers.batch_norm(sub_conv9, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv10 = tf.layers.conv2d(inputs=sub_conv9,
                                          ...
                                          kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                          name='sub_conv10')
            sub_conv10=tf.contrib.layers.batch_norm(sub_conv10, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv11 = tf.layers.conv2d(inputs=sub_conv10,
                                          ...
                                          kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                          name='sub_conv11')
            sub_conv11=tf.contrib.layers.batch_norm(sub_conv11, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv12 = tf.layers.conv2d(inputs=sub_conv11,
                                          ...
                                          kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                          name='sub_conv12')
            sub_conv12=tf.contrib.layers.batch_norm(sub_conv12, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv13 = tf.layers.conv2d(inputs=sub_conv12,
                                          ...
                                          kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                          name='sub_conv13')
            sub_conv13=tf.contrib.layers.batch_norm(sub_conv13, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            sub_conv14 = tf.layers.conv2d(inputs=sub_conv13,
                                          ...
                                          kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                          name='sub_conv14')
            sub_conv14=tf.contrib.layers.batch_norm(sub_conv14, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            ...
            self.sub_stage_img_feature=tf.contrib.layers.batch_norm(self.sub_stage_img_feature, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
        with tf.variable_scope('stage_1'):
            conv1 = tf.layers.conv2d(inputs=self.sub_stage_img_feature,
                                     ...
                                     kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                     name='conv1')
            conv1=tf.contrib.layers.batch_norm(conv1, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
    ...
    def _middle_conv(self, stage):
        with tf.variable_scope('stage_' + str(stage)):
            ...
            mid_conv1 = tf.layers.conv2d(inputs=self.current_featuremap,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv1')
            mid_conv1=tf.contrib.layers.batch_norm(mid_conv1, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            mid_conv2 = tf.layers.conv2d(inputs=mid_conv1,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv2')
            mid_conv2=tf.contrib.layers.batch_norm(mid_conv2, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            mid_conv3 = tf.layers.conv2d(inputs=mid_conv2,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv3')
            mid_conv3=tf.contrib.layers.batch_norm(mid_conv3, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            mid_conv4 = tf.layers.conv2d(inputs=mid_conv3,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv4')
            mid_conv4=tf.contrib.layers.batch_norm(mid_conv4, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            mid_conv5 = tf.layers.conv2d(inputs=mid_conv4,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv5')
            mid_conv5=tf.contrib.layers.batch_norm(mid_conv5, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
            mid_conv6 = tf.layers.conv2d(inputs=mid_conv5,
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=False),
                                         name='mid_conv6')
            mid_conv6=tf.contrib.layers.batch_norm(mid_conv6, 0.9, epsilon=1e-5, activation_fn=tf.nn.relu, is_training=self.is_training)
    ...
    def build_loss(self, lr, lr_decay_rate, lr_decay_step, optimizer='Adam'):
        ...
        for stage in range(self.stages):
            with tf.variable_scope('stage' + str(stage + 1) + '_loss'):
                self.stage_loss[stage] = self.stage_loss[stage] = tf.nn.l2_loss(self.stage_heatmap[stage] - self.gt_hmap_placeholder,
